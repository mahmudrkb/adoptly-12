        ...
        <div className=" lg:flex   gap-10 ">
          <div className="">
            ...
            <p className="mt-6 max-w-md text-gray-600 dark:text-gray-300">
              ...
              before finding their forever family. Our dedicated team provides a
              seamless adoption experience, offering support, resources, and
              guidance every step of the way. From adopting to post-adoption
              care, we're here to help you give a pet the life they deserve.
              Join us in making a difference—adopt today and give a pet a second
              chance at happiness.
            </p>
          </div>
          <div>
              ...
              {people.map((person) => (
                <li key={person.name}>
                  <div className="flex  items-center gap-x-6">
                    ...
                    />
                    <div>
                      <h3 className="text-base/7 font-semibold tracking-tight dark:text-white text-gray-900">
                        {person.name}
                      </h3>
