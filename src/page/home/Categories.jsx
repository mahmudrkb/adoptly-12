  ...
  return (
    <div className="flex justify-center mt-10 lg:-mt-20">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="flex-col  bg-teal-300 lg:bg-white border-2 border-orange-100 p-5 rounded-md items-center">
          <img className="size-20 mx-auto" src={cat} alt="" />
          <h3 className="text-center mt-4 text-gray-800 font-semibold text-xl ">
            Cats
          </h3>
        </div>
        <div className="flex-col bg-teal-300 lg:bg-white border-2 border-orange-100 p-5 rounded-md items-center">
