...
const Login = () => {
  return (
    <div className="container mx-auto p-3 my-5 ">
        <Link to={"/"} className="flex hover:text-teal-300 items-center  gap-3"><FaArrowLeft></FaArrowLeft>Back to Home </Link>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6  lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <h2 className="my-5 text-center text-2xl/9 font-bold tracking-tight text-gray-800">
            Sign In To <span className="text-teal-300"> Your Account</span>
          </h2>
        </div>
       ...
       <div className="p-7  bg-gray-50 rounded-md shadow-md sm:mx-auto sm:w-full sm:max-w-sm">
